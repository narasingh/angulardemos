app.controller('CustomerLoginController', function($scope, Data, Common, $location){
	
	$scope.guestLogin = function(params){
...
app.controller('CustomerOrdersController', function ($scope, $routeParams, customersService, $route) {
    $scope.customer = {};
	...
	$scope.deleteOrder = function(orderId){
		...
		var customerID = ($routeParams.customerID) ? parseInt($routeParams.customerID) : 0;
		customersService.deleteOrder(orderId, customerID);
